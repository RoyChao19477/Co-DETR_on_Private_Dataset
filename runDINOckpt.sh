...
python -m torch.distributed.launch --nproc_per_node=1 --master_port=$PORT \
    tools/train.py projects/configs/coDETR_r/co_dino_5scale_swin_large_16e_o365tococo_ckpt.py --launcher pytorch --work-dir ckpt/co_dino_5scale_lsj_swin_large_3x_coco__batch4_v4_conti3
